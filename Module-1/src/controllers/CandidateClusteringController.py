...
class CandidateClusteringController(BaseController):
    ...
    # -------------------------------------------------
    def save_clusters(self, path: str = "candidate_clusters.pkl"):
        """Save cluster state to disk"""
        self.model.save(path)
        print(f"💾 Saved clusters to {path}")

    def load_clusters(self, path: str = "candidate_clusters.pkl"):
